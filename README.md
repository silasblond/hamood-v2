...
> Åbn denne side på [https://silasblond.github.io/hamood-v2/](https://silasblond.github.io/hamood-v2/)
...
* søg efter **https://github.com/silasblond/hamood-v2**, og importer

## Rediger dette projekt ![Byggestatus-badge](https://github.com/silasblond/hamood-v2/workflows/MakeCode/badge.svg)

Sådan redigerer du dette lager i MakeCode.

* åbn [https://makecode.microbit.org/](https://makecode.microbit.org/)
* klik på **Importer**, og klik derefter på **Import-URL-adresse**
* indsæt **https://github.com/silasblond/hamood-v2**, og klik på Importer
...
![En genereret visning af blokkene](https://github.com/silasblond/hamood-v2/raw/master/.github/makecode/blocks.png)
